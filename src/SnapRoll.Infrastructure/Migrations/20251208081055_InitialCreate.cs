        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    LateThresholdSeconds = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SessionId = table.Column<Guid>(type: "uuid", nullable: false),
                    StudentId = table.Column<string>(type: "text", nullable: false),
                    TokenUsed = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    ScanResult = table.Column<int>(type: "integer", nullable: false),
                    DeviceMetadata = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ScanLogs_AspNetUsers_StudentId",
                        column: x => x.StudentId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ScanLogs_Sessions_SessionId",
                        column: x => x.SessionId,
                        principalTable: "Sessions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScanLogs_ScanResult",
                table: "ScanLogs",
                column: "ScanResult");

            migrationBuilder.CreateIndex(
                name: "IX_ScanLogs_SessionId",
                table: "ScanLogs",
                column: "SessionId");

            migrationBuilder.CreateIndex(
                name: "IX_ScanLogs_StudentId",
                table: "ScanLogs",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_Sessions_CourseId_StartTime",
                table: "Sessions",
